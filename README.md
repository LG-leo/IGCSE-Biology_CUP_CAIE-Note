...
### For students
1. **Read the topic** from start to finish. Pay special attention to ***triple‑asterisk sections*** – these are the points where students often lose marks.
2. **Use the tables** as quick revision summaries (e.g. vertebrate classes, digestive enzymes, heart structures).
3. **Practice the “Common exam questions”** at the end of each topic – cover the model answer and try to write your own.
4. **For formulas** (e.g. magnification, percentage change), make sure you can rearrange them and apply them to unfamiliar data.
